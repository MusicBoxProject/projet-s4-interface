...
export const PLAYLISTS: Playlist[] = [
  { id: "1", name: 'Beyonce',description:'Latest album from Beyonce',tagId:"No Tag",type:"Music",
  media:[
  ...
  { id: "2", name: 'Beyonce',description:'Latest album from Beyonce',tagId:"No Tag",type:"Music",
  media:[
    {uriType:"URL", title:"firstsong",author:"beyonce feat jayz" ,uri:"music.com"},
    {uriType:"URL", title:"firstsong",author:"beyonce feat jayz" ,uri:"music.com"},
    {uriType:"URL", title:"firstsong",author:"beyonce feat jayz" ,uri:"music.com"},
